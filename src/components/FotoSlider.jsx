  ...
  return (
    <div className={className}>
      ...
      <div className="flex justify-center text-center relative 2xl:w-1/2 xl:w-1/2 lg:w-3/5 md:3/5 sm:w-4/5 w-11/12 h-auto">
        <button className="flechas absolute top-2/4 left-1 z-30" onClick={irAtras}><ion-icon name="arrow-dropleft"></ion-icon></button>
        <button className="flechas absolute top-2/4 right-1 z-30" onClick={irSiguiente}><ion-icon name="arrow-dropright"></ion-icon></button>
        <img
